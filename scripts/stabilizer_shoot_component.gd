...
@export
var heat_capacity: int = 500

@export 
var heat_applied_by_shoot: int = 100

@export
var heat_decrease_over_time: int = 10

@export
var overload_time: float = 2.0

@export
var shoot_position: Node2D = null

var cur_heat: int = 0
var overloading: bool = false

@onready
var overload_timer: Timer = Timer.new()
